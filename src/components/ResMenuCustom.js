...
//    const[resInfoData, setResInfoData] = useState(null);
   ...
   const[address, setAddress]= useState(null)
    ...
    if(  loading && resInfoData===null){
        <Shimmer/>
        console.log("loading true")
    }
    else{
        // console.log("else below rerurn ")
        // console.log("area completeAddress::",footer?.card?.card?.name," :",footer?.card?.card?.completeAddress)
        // console.log("footern: is here ",footer);
        // console.log("heading:, ",menuHeading, menuItems, menuList)
            ...
            <div className="mainMenu">
                ...
                <div className="footer">
                    <div className="fassai">
                        ...
                        <h3>{ text && text[0]? text[0]: "No text Available"} </h3>
                    </div>
                    <hr/>
